...
SIZE 1M AUTOEXTEND ON NEXT 1K; -- 초기의 저장소 공간을 1M(Byye)확보하고
                               -- 혹시 부족하면 1K(Byte)씩 자동으로 증가하라
         
-- 2. 사용자 생성(CREATE 키워드)
-- student 라는 사용자를 생성하고 비밀번호를 12341234로 설정하고
...
-- 3. 생성한 사용자에게 권한을 부여
-- 사용자(student)는 DBMS 소프트웨어 로그인을 하고
...
--      원칙적으로 권한 부연느 각각 항목별로 세부적으로 부여해야 하지만
